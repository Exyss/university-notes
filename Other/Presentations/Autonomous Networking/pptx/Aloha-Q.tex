...
\framesubtitle{Wireless Sensor Networks}
    ...
    \begin{columns}
        \begin{column}{0.5\textwidth}
            ...
            \boldred{Wireless Sensor Network (WSN)} are networks of composed of distributed sensing devices used to monitor and record environmental conditions and events.
...
\framesubtitle{Wireless Sensor Networks}
    ...
    WSNs are emplyed \boldred{\textit{everywhere}} there is a need for monitoring a physical space or using sensors for controlling a procedure.
...
\framesubtitle{The Aloha-Q protocol}
    ...
    \begin{itemize}[<+->]
        ...
        \begin{itemize}
            \item Value are updated after each transmission
        ...
        \item Nodes \boldred{wake up} only when they need to transmit and to receive the associated ACKs
        \begin{itemize}
...
\framesubtitle{The Aloha-Q protocol}
    ...
    \begin{itemize}[<+->]
        \item Q values range from $-1$ to $1$
...
\framesubtitle{The Aloha-Q protocol}
    ...
    \begin{itemize}[<+->]
        ...
        \end{itemize}
        \item A reward $r = +1$ is given for \boldred{succesful}, while $r = -1$ is given for \boldred{collision}
        \begin{itemize}
