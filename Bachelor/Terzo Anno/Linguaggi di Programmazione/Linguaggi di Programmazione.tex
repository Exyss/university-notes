...
\begin{document}
    ...
    \begin{itemize}
        \item Date le due algebre $(\R, +)$ e $(\R_{> 0}, \cdot)$, sappiamo giò che $\funcmap{\mathrm{exp}}{\R}{\R_{> 0}}{x}{e^x}$ sia un omomorfismo
    ...
    \begin{frameddefn}{Scoping dinamico}
        Definiamo un linguaggio come linguaggio a \textbf{scoping statico} se durante la valutazione di un'espressione viene utilizzato l'ambiente definito al tempo di valutazione stesso.
    \end{frameddefn}
    ...
    In senso improprio, possiamo dire che tale tipo afferma che textit{"indipendentemente dal tipo $Y$, verrà restituito un elemento di tipo $X$"}.
