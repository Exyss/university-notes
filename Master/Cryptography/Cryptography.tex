...
\begin{document}
    ...
    \begin{enumerate}
        ...
        \item The above procedure is repeated with the two challenge messages $m_0^*, m_b^*$ sent by $A^{\text{CPA}}_{\Pi}$, where $A^{\text{CPA}}_{\Pi'}$ returns the challenge ciphertext $c^*$ obtained from $C^{\text{CPA}}_{\Pi'}$
    ...
    \begin{framedalgo}{FDH DS scheme}
        ...
        \begin{itemize}
            \item $(pk, sk) \in_R \mathrm{KGen}(1^{\lambda})$ where $pk = (n,e)$ and $sk = (n,d)$, with $n = pq$ for two primes $p,q \in \Primes$ of approximately $\lambda$ bits and $e,d$ being each other's inverse in $\Z_{\varphi(n)}$, i.e. $ed \equiv 1 \pmod{\varphi(n)}$
            \item $\mathrm{Sign}(sk, m) = (m, f^{-1}(sk, H(s)))$
    ...
    \begin{proof}
        ...
        \begin{enumerate}
            ...
            \item $A^{\text{CPA}}_{\Pi}$ makes $q = \poly(n)$ encryption queries to $A^{\text{HPC}}_{h_{pk}}$. For each query $m_i$, $A^{\text{HPC}}_{h_{pk}}$ returns $(f_{pk}(r_i), h_{pk}(r_i) \oplus m_i)$, for some random $r_i \in_R \mathcal{U}_n$
    ...
    \begin{framedprob}{}
        ...
        \begin{enumerate}
            ...
            \item Show that the RSA PKE scheme is not anonymous (even under the DDH assumption)
        \end{enumerate}
    \end{framedprob}
    ...
    \begin{enumerate}
        ...
        \begin{enumerate}
            ...
            \item The adversary returns $b' = \1[c^* < n_0]$
        \end{enumerate}
        
        W.l.o.g. assume $n_0 < n_1$. When $b = 0$ the condition $c^* < n_0$ is always true, therefore $\Pr[A \text{ returns } 0 \mid b = 0] = \Pr[c^* < n_0 \mid b= 0 ] =  1$. When $b = 1$, instead, we have that
    ...
    \begin{proof}
        ...
        \begin{enumerate}
            \item $A$ will substitute the oracle for $H$, answering $A^H$ RO queries.
            \item The challenger $C$ sends $ok$ to $A$, who then forwards it to $A^H$
            \item $A^H$ tells $A$ that they will make $q = \poly(\lambda)$ RO queries. 
