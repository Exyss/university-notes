...
\begin{frameddefn}{O grande}
    ...
    \begin{center}
        \includegraphics[scale=0.75]{images/chapter_2/bigO_1.png}
    \end{center}
...
\begin{itemize}
    ...
    \begin{center}
        \includegraphics[scale=0.6]{images/chapter_2/bigO_2.png}
    \end{center}
    ...
    \begin{center}
        \includegraphics[scale=0.6]{images/chapter_2/bigO_3.png}
    \end{center}
...
\newpage
    ...
    \begin{center}
        \includegraphics[scale=0.75]{images/chapter_2/omega_1.png}
    \end{center}
...
\begin{itemize}
    ...
    \begin{center}
        \includegraphics[scale=0.6]{images/chapter_2/omega_2.png}
    \end{center}
\end{itemize}
...
\quad
    ...
    \begin{center}
        \includegraphics[scale=0.75]{images/chapter_2/theta_1.png}
    \end{center}
...
\begin{center}
    \includegraphics[scale=0.8]{images/chapter_3/bin_search.png}
...
\begin{center}
    \includegraphics[scale=0.75]{images/chapter_4/fib_5.png}
\end{center}
...
\begin{center}
    \includegraphics[scale=0.8]{images/chapter_6/tree_m1.png}
\end{center}
...
\begin{center}
    \includegraphics[scale=0.8]{images/chapter_6/tree_m2.png}
\end{center}
...
\begin{center}
    \includegraphics[scale=0.8]{images/chapter_6/tree_m3.png}
\end{center}
...
\begin{center}
    \includegraphics[scale=0.8]{images/chapter_6/tree_m4.png}
\end{center}
...
\begin{center}
    \includegraphics[scale=0.525]{images/chapter_7/insertion_sort.png}
\end{center}
...
\begin{center}
    \includegraphics[scale=0.525]{images/chapter_7/selection_sort.png}
\end{center}
...
\begin{center}
    \includegraphics[scale=0.6]{images/chapter_7/bubble_sort.png}
\end{center}
...
\begin{center}
    \includegraphics[scale=0.65]{images/chapter_7/decision_tree.png}
\end{center}
...
\begin{center}
    \includegraphics[scale=0.7]{images/chapter_7/merge_sort.png}
\end{center}
...
\begin{center}
    \includegraphics[scale=0.45]{images/chapter_7/fuse_algorithm.png}
\end{center}
...
\begin{center}
    \includegraphics[scale=0.6]{images/chapter_7/quicksort.png}
\end{center}
...
\begin{center}
    \includegraphics[scale=0.65]{images/chapter_7/heap.png}
\end{center}
...
\begin{center}
    \includegraphics[scale=0.7]{images/chapter_7/heap2.png}
\end{center}
...
\begin{center}
    \includegraphics[scale=0.6]{images/chapter_7/heapify.png}
\end{center}
...
\begin{center}
    \includegraphics[scale=0.7]{images/chapter_7/heapify2.png}
\end{center}
...
\begin{center}
    \includegraphics[scale=0.7]{images/chapter_7/buildheap.png}
\end{center}
...
\begin{center}
    \includegraphics[scale=0.45]{images/chapter_7/heapsort.png}
\end{center}
...
\begin{center}
    \includegraphics[scale=0.5]{images/chapter_7/counting_sort.png}
\end{center}
...
\begin{center}
    \includegraphics[scale=0.65]{images/chapter_8/pointers.png}
\end{center}
...
\begin{center}
    \includegraphics[scale=0.65]{images/chapter_8/linked_list.png}
\end{center}
...
\begin{center}
    \includegraphics[scale=0.65]{images/chapter_8/linked_list_2.png}
\end{center}
...
return e, top
    ...
    \begin{tabular}{c}
        \includegraphics[scale=0.7]{images/chapter_8/stack.png}
    \end{tabular}
\end{tabular}
...
\begin{center}
    \includegraphics[scale=0.6]{images/chapter_8/queue.png}
\end{center}
...
\begin{center}
    \begin{tabular}{c c c}
    \includegraphics[scale=0.55]{images/chapter_8/graph.png}
    & \qquad \qquad &
    \includegraphics[scale=0.55]{images/chapter_8/tree_1.png}
    \\
...
\begin{tabular}{m{0.4625 \textwidth} p{0.0125 \textwidth} p{0.4 \textwidth}}
    ...
    & &
    \begin{tabular}{c}
        \includegraphics[scale=0.6]{images/chapter_8/tree_2.png}
    \end{tabular}
\end{tabular}
...
\begin{center}
    \includegraphics[scale=0.65]{images/chapter_8/tree_3.png}
\end{center}
...
\begin{center}
    \includegraphics[scale=0.6]{images/chapter_8/tree_4.png}
\end{center}
...
\begin{itemize}
    ...
    \begin{center}
        \includegraphics[scale=0.5]{images/chapter_8/tree_5.png}
    \end{center}
    ...
    \begin{center}
        \includegraphics[scale=0.6]{images/chapter_8/tree_6.png}
    \end{center}
    ...
    \begin{center}
        \includegraphics[scale=0.6]{images/chapter_8/tree_7.png}
    \end{center}
\end{itemize}
...
\begin{enumerate}
    ...
    \begin{center}
        \includegraphics[scale=0.55]{images/chapter_8/tree_4.png}
    \end{center}
...
\begin{center}
    \includegraphics[scale=0.6]{images/chapter_8/tree_8.png}
\end{center}
...
\begin{center}
    \includegraphics[scale=0.85]{images/chapter_8/tree_9.png}
\end{center}
...
\begin{center}
    \includegraphics[scale=0.8]{images/chapter_8/arb_1.png}
\end{center}
...
\begin{center}
    \includegraphics[scale=0.475]{images/chapter_8/arb_2.png}
\end{center}
...
\begin{itemize}
    ...
    \begin{enumerate}
        ...
        \begin{center}
            \includegraphics[scale=0.7]{images/chapter_8/arb_4.png}
        \end{center}
        ...
        \begin{center}
            \includegraphics[scale=0.7]{images/chapter_8/arb_5.png}
        \end{center}
        ...
        \begin{center}
            \includegraphics[scale=0.7]{images/chapter_8/arb_6.png}
        \end{center}
    \end{enumerate}
    ...
    \begin{center}
        \includegraphics[scale=0.7825]{images/chapter_8/arb_7.png}
    \end{center}
...
\end{itemize}
    ...
    \begin{center}
        \includegraphics[scale=0.675]{images/chapter_8/dictionaries_1.png}
    \end{center}
    ...
    \begin{center}
        \includegraphics[scale=0.65]{images/chapter_8/dictionaries_2.png}
    \end{center}
    ...
    \begin{center}
        \includegraphics[scale=0.7]{images/chapter_8/dictionaries_3.png}
    \end{center}
...
def Delete_ListeTrabocco (A; k: chiave da canc.)
    ...
    \begin{center}
        \includegraphics[scale=0.625]{images/chapter_8/dictionaries_4.png}
    \end{center}
