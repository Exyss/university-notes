...
\begin{document}
    ...
    As $m$ grows to infinity, the latter probability goes to 0, making it negligible. Tihis implies that both $\Pr[Y=0]$ and $\Pr[Y = 1]$ tend to be $\frac{1}{2}$ due to them having the same probability and them being the only two outcomes. This makes $Y$ a fair enough coin.
